<template>
  <section class="relative w-full" data-aos="zoom-in-up">
    <div class="absolute top-0 inset-x-0 h-64 flex items-start">
      <div
        class="h-24 w-2/3 bg-gradient-to-br from-[#570cac] blur-2xl invisible opacity-40"></div>
      <div
        class="h-20 w-3/5 bg-gradient-to-r from-[#670ccf] opqcity-40 blur-2xl"></div>
    </div>
    <div
      ...
      <div
        ...
        <div class="lg:py-6">
          ...
          <p
            ...
            I'm a Junior Developer, Passionate about Web Development, Mobile
            Development, and Internet of Things. Looking forward to be better.
          </p>
          <div
        ...
        <div class="lg:h-full md:flex">
          <div
            ...
            <div
              class="absolute z-0 top-1/2 -translate-y-1/2 w-5/6 right-0 h-[calc(80%+20px)] bg-gradient-to-tr opacity-25 from-[#570cac] to-primary blur-2xl"></div>
            <div
